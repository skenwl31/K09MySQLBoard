...
web.xml에 기술하는것과 동일하게 입력이 잘못되는 경우
톰캣이 시작되지 않을 수 있으므로 주의해야 한다.
...
public class ViewController extends HttpServlet {
	...
	전송방식에 상관없이 먼저 받아 doGet() 혹은 doPost()로
	요청을 전달하는 역할을 한다. 따라서 전송방식에 상관없이
	요청을 처리할 수 있다.
	*/
...
//		내용에 대해서는 줄바꿈 처리를 위해 <br>태그로 변경한다.
		...
		//변환된 List컬렉션에 우리가 첨부한 이미지의 확장자가
		//있는지 확인한다.
